...
mixin _$CvPresentationPreferences {
 ...
 String get designId; List<CvSection> get sectionOrder; List<CvSection> get hiddenSections;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CvPresentationPreferences&&(identical(other.designId, designId) || other.designId == designId)&&const DeepCollectionEquality().equals(other.sectionOrder, sectionOrder)&&const DeepCollectionEquality().equals(other.hiddenSections, hiddenSections));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,designId,const DeepCollectionEquality().hash(sectionOrder),const DeepCollectionEquality().hash(hiddenSections));

@override
String toString() {
  return 'CvPresentationPreferences(designId: $designId, sectionOrder: $sectionOrder, hiddenSections: $hiddenSections)';
}
...
@useResult
$Res call({
 String designId, List<CvSection> sectionOrder, List<CvSection> hiddenSections
});
...
/// Create a copy of CvPresentationPreferences
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? designId = null,Object? sectionOrder = null,Object? hiddenSections = null,}) {
...
as String,sectionOrder: null == sectionOrder ? _self.sectionOrder : sectionOrder // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String designId,  List<CvSection> sectionOrder,  List<CvSection> hiddenSections)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CvPresentationPreferences() when $default != null:
return $default(_that.designId,_that.sectionOrder,_that.hiddenSections);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String designId,  List<CvSection> sectionOrder,  List<CvSection> hiddenSections)  $default,) {final _that = this;
switch (_that) {
case _CvPresentationPreferences():
return $default(_that.designId,_that.sectionOrder,_that.hiddenSections);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String designId,  List<CvSection> sectionOrder,  List<CvSection> hiddenSections)?  $default,) {final _that = this;
switch (_that) {
case _CvPresentationPreferences() when $default != null:
return $default(_that.designId,_that.sectionOrder,_that.hiddenSections);case _:
  return null;
...
class _CvPresentationPreferences extends CvPresentationPreferences {
  const _CvPresentationPreferences({this.designId = 'professional',  List<CvSection> sectionOrder = const <CvSection>[],  List<CvSection> hiddenSections = const <CvSection>[]}): _sectionOrder = sectionOrder,_hiddenSections = hiddenSections,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CvPresentationPreferences&&(identical(other.designId, designId) || other.designId == designId)&&const DeepCollectionEquality().equals(other._sectionOrder, _sectionOrder)&&const DeepCollectionEquality().equals(other._hiddenSections, _hiddenSections));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,designId,const DeepCollectionEquality().hash(_sectionOrder),const DeepCollectionEquality().hash(_hiddenSections));
...
/// Create a copy of CvPresentationPreferences
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? designId = null,Object? sectionOrder = null,Object? hiddenSections = null,}) {
  return _then(_CvPresentationPreferences(
designId: null == designId ? _self.designId : designId // ignore: cast_nullable_to_non_nullable
as String,sectionOrder: null == sectionOrder ? _self._sectionOrder : sectionOrder // ignore: cast_nullable_to_non_nullable
